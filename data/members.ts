...
export const members: Member[] = [
    ...
    // ACTIVE MEMBERS
    {
        ...
        years: [2024, 2025],
        historicalRoles: [{ year: 2025, role: "Autonomous Developer" }],
    },
    {
        id: "levi-bolie",
        name: "Levi Bolie",
    ...
    },
    {
        ...
        image: "/images/members/agney.png",
        bio: "I'm Agney Kakkunnath, and this is my fifth year in FTC. As a main builder, I'm fully dedicated to the building process, ensuring everything is designed and assembled to help the team perform at its best. I'm also skilled at CAD and love encouraging the team to stay motivated and work together!",
        years: [2024, 2025],
    ...
    },
    {
        ...
        name: "Ritvik Agarwal",
        role: "CAD • Builder",
        image: "/images/members/Ritvik.jpg",
        bio: "As a longtime member of Ragnarok, I've had the chance to dive into both programming and building, along with CAD. I started coding when I was 10 and have experience with HTML, CSS, JavaScript, Python, and Java. Now in my fifth year of FTC, I'm always looking to improve my skills and take on new challenges to help the team succeed!",
        years: [2024, 2025],
        historicalRoles: [{ year: 2024, role: "Teleoperations Manager" }],
    },
    {
        id: "adarsh-rajesh",
        name: "Adarsh Rajesh",
